...
if var == 'phi':
	...
	cs = ax.contour(lon2,lat2,field/9.81,levels=np.arange(4800,6100,100),transform=ccrs.PlateCarree(),colors='black')
	cs = ax.contourf(lon2,lat2,field/9.81,levels=np.arange(4800,6100,100),transform=ccrs.PlateCarree(),cmap='jet')
