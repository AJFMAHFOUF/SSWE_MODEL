...
lon1,lat1,vor,u,v,psi=np.loadtxt('../data_out/BVE_model_T'+trunc+'_step_'+nstep+'_expid_'+expid+'.dat',unpack=True)
if var == 'psi':
...
plt.savefig('../plots/BVE_'+var+'_500_T'+trunc+'_step_'+nstep+'_expid_'+expid+'_NH.pdf')
plt.show()
